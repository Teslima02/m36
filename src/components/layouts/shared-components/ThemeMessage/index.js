...
class ThemeMessage extends Component {
    render()
    {
                    ...
                    message={
                        <div className={classes.message}>
                            {variantIcon[options.variant] && (
                                <Icon className={classes.icon} color="inherit">{variantIcon[options.variant]}</Icon>
                            )}
                            {options.message}
                        </div>
                    }
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(ThemeMessage));
